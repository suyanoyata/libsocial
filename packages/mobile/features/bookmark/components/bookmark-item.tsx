...
export const BookmarkItem = memo(({ bookmark }: { bookmark: BookmarkListItem }) => {
  ...
  return (
    <Animated.View entering={FadeIn} exiting={FadeOut}>
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        >
          <FastImage
            source={{ uri: bookmark.media.cover.thumbnail }}
        ...
        <SheetContent>
          <BookmarkSelectBase
            ...
            data={bookmark}
            onSelect={(value) => mutate({ name: value as BookmarkName, id: bookmark.id })}
          />
        </SheetContent>
      </Sheet>
    </Animated.View>
