...
export const Profile = () => {
  ...
  return (
    <View>
      ...
      <View className="bg-muted-darken rounded-2xl p-2 px-4 py-3 mt-3 active:bg-muted flex-row items-center gap-2">
        {data.user.image && (
          <FastImage
        ...
        <View className="mr-auto flex-1">
          ...
          <Text className="text-muted font-medium">
            Joined at {new Date(data.user.createdAt).toLocaleDateString()}
          </Text>
        </View>
