...
export const AuthFlow = () => {
  ...
  if (!data) {
    return (
      <View>
        <Text className="text-3xl text-primary font-extrabold mb-2 mt-4">Sign In with</Text>
    ...
    return (
      <View className="gap-2 mt-4">
        <Alert>
          ...
          <AlertDescription>
            You are signed in as anonymous. Once you sign out or delete application your data will
            be gone
          </AlertDescription>
        </Alert>
        <SignInDiscord />
